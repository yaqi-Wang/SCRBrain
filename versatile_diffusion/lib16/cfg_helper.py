...
class model_cfg_bank(object):
    def __init__(self):
        self.cfg_dir = osp.join('/home/data/wangyaqi/projects/10StableDiffusionReconstruction/10StableDiffusionReconstruction-main/codes/utils/versatile_diffusion/configs/', 'model')
        self.cfg_bank = edict()
