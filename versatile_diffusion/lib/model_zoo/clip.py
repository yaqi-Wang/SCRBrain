...
class FrozenCLIPTextEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="/home/data/wangyaqi/projects/2023121802/brain-diffuser-main/versatile_diffusion/huggingface/clip-vit-large", device="cuda", max_length=77):  # clip-vit-base-patch32
    # 
        super().__init__()
...
class FrozenCLIP(AbstractEncoder):
    def __init__(self, 
                ...
                #  version='/home/data/wangyaqi/projects/10StableDiffusionReconstruction/10StableDiffusionReconstruction-main/codes/utils/versatile_diffusion/huggingface/clip-vit-large',
                 version = 'versatile_diffusion/huggingface/clip-vit-large',
                 max_length=77, 
