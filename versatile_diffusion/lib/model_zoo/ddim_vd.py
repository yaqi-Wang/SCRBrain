...
class DDIMSampler_VD(DDIMSampler):
    ...
    def stochastic_encode(self, x0, t, use_original_steps=False, noise=None):
        ...
        sqrt_alphas_cumprod = sqrt_alphas_cumprod.to(device=t.device, dtype=x0.dtype)
        sqrt_one_minus_alphas_cumprod = sqrt_one_minus_alphas_cumprod.to(device=t.device, dtype=x0.dtype)
